...
public class EditSemester extends JDialog {
	...
	private Preferences prefs = Preferences.userRoot().node("lernzielnator/preferences/editSemester");
	 ...
	 * Create the dialog.
	 */
	public EditSemester(final JFrame frame, final MainWindow mainWindow, Semester semester, Lernzielnator lernzielnator) {
		...
		setBounds(100, 100, 170, 165);
		setLocationRelativeTo(frame);
		setBounds(prefs.getInt("x", getX()), prefs.getInt("y", getY()), prefs.getInt("w", 170), prefs.getInt("h", 165));
